...
module.exports = {
  ...
  async run(client, message, args) {
    ...
    const Index = new Discord.MessageEmbed()
      ...
      .addFields(
        {
          name: "🤖  | __Contents (***Page 1***)__",
          value: "\u200B",
        },
        {
          name: "🛡  | Moderation (***Page 2***)",
          value: "\u200B",
        },
        {
          name: "😄  | Fun (***Page 3***)",
    ...
    const moderation = new Discord.MessageEmbed()
      ...
      .addField(
        `${prefix}warnings`,
        "shows the amount of warnings a person has"
      )
    ...
    const fun = new Discord.MessageEmbed()
      ...
      .addField(
        `${prefix}snipe`,
        "Snipe that message like the true marksman you are"
      )
    ...
    const utility = new Discord.MessageEmbed()
      ...
      .addField(
        `${prefix}weather`,
        "Checks weather forecast for provided location"
      )
    ...
    const pages = [Index, moderation, fun, Giveaway, utility, Config];
