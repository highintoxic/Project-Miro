...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (moneyCheck < args[0]){
            sendMessage(message.channel, `>>> You only have ${bankValue} Coins In Your Bank \nYou Need ${args[0] - bankValue} More Coins`)
            return;
        }
