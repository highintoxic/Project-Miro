  ...
  run: async (client, message, args) => {
    ...
    if (!message.author.id === owners)
      return message.reply(
        "you do not have perms to use this command, Only The Owner Of The Bot Have Access"
      );
    ...
    let moneyEmbed = new Discord.MessageEmbed()
      .setColor("RANDOM")
      .setDescription(
        `<:white_check_mark:753232686310752331> Successfuly Removed ${args[1]} coins From ${user} \nNew User's Balance: ${coins}`
      );
